        ...
        {!!profileImageSrc && (
          <div className="col-span-1 md:col-span-2 flex flex-col justify-between">
            ...
            <div className="flex justify-center">
              <div className="relative h-32 w-32 overflow-hidden md:h-[34rem] md:w-[30rem]">
                <Image alt="about-me-image" className="h-full w-full object-contain rounded-lg" src={profileImageSrc} />
              </div>
            </div>
            {/* Infos sous l'image */}
            <ul className="grid grid-cols-1 gap-4 sm:grid-cols-2 " style={{fontFamily: 'Roboto, sans-serif'}}>
          ...
          <div className={classNames('col-span-1 flex flex-col gap-y-6', {'md:col-span-3': !!profileImageSrc})}>
            <div className="flex flex-col gap-y-2">
              ...
              <h2 className="text-4xl font-light self-center text-black mb-6" style={{fontFamily: '"Noto SD 500", Arial, sans-serif'}}>À propos de moi</h2>
